  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row">
        <div>
          <h1 className="text-xl font-bold">Pet Adoption Checklist: Things to Consider Before Adopting a Pet</h1>
          <img
          ...
          <h3 className="text-lg font-semibold mt-4">1.What to Expect When Adopting a New Pet?</h3>
          ...
          <ul className="list-disc list-inside">
            <li><strong>a)Routine:</strong> Instead of hitting the snooze button, you’ll need to walk the dog, serve meals, and manage potty breaks.</li>
            <li><strong>b)Budget:</strong> Expect expenses like food, vet care, grooming, and other costs.</li>
            <li><strong>c)Lifestyle:</strong> If you rent, ensure your landlord allows pets — now and in future rentals.</li>
          </ul>
          ...
          <h3 className="text-lg font-semibold mt-4">2.Where Can I Adopt a Pet?</h3>
          ...
          <h3 className="text-lg font-semibold mt-4">3.What Types of Pets Are Available for Adoption?</h3>
          ...
          <h3 className="text-lg font-semibold mt-4">4.Benefits of Adopting From a Shelter or Rescue</h3>
          ...
          <h3 className="text-lg font-semibold mt-4">5.What to Consider Before Adopting?</h3>
          <p>Knowing what to expect can make the transition smoother. Here are ten things to consider:</p>
          <ol className="list-decimal list-inside">
            <li><strong>I-Landlord permission:</strong> Make sure your landlord allows pets before adopting.</li>
            <li><strong>II-Adjust your schedule:</strong> Pets need care and companionship, so schedule accordingly.</li>
            <li><strong>III-Privacy:</strong> Pets may accompany you even to the bathroom — privacy is a thing of the past!</li>
            <li><strong>IV-Costs:</strong> Budget for food, vet care, grooming, and more.</li>
            <li><strong>V-Don't adopt on a whim:</strong> Take time to think through this long-term commitment.</li>
            <li><strong>VI-Prepare for mess:</strong> Pets can create messes like poop and vomit, so be prepared.</li>
            <li><strong>VII-Pet hair:</strong> Expect pet hair everywhere — embrace it!</li>
            <li><strong>VIII-Older animals:</strong> Older pets make great companions, so don’t overlook them.</li>
            <li><strong>IX-Socialization:</strong> Dogs need socialization and training to thrive.</li>
            <li><strong>X-Pet-proof your home:</strong> Make necessary changes to ensure your home is safe for a pet.</li>
          </ol>

          <h3 className="text-lg font-semibold mt-4">Commonly Asked Questions</h3>
          <h4 className="font-semibold mt-2">1.Why should I consider adopting a pet instead of buying one?</h4>
          <p>Adopting saves lives and gives pets a chance at a happy life. Plus, it's more affordable than buying from breeders.</p>

          <h4 className="font-semibold mt-2">2.What are the essential factors to consider before adopting?</h4>
          <p>Consider the long-term costs and how your schedule will change before adopting a pet.</p>

          <h4 className="font-semibold mt-2">3.Where can I adopt a pet?</h4>
          <p>Use Adopt a Pet’s search tool to find adoptable pets near you.</p>

          <h4 className="font-semibold mt-2">4.What types of pets are available?</h4>
          <p>Besides cats and dogs, shelters often have rabbits, guinea pigs, and birds available for adoption.</p>

          <h4 className="font-semibold mt-2">5.What are the benefits of adopting from a shelter?</h4>
          <p>Adopting saves lives and makes space for shelters to rescue more pets in need.</p>

          <h4 className="font-semibold mt-2">6.How do I ensure a successful adoption?</h4>

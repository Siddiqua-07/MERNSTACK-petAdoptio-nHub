...
export const PetPage = () => {
      ...
      <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
        ...
        <div>
          ...
          <p className="text-base leading-4 mt-7 text-gray-600">
            <span className="font-semibold">Adoption Fee:</span> Rs {pet.fee}
          </p>
        ...
        <div>
          <div className="border-t border-b py-4 mt-7 border-gray-200">
            ...
            >
              <p className="text-base leading-4 text-gray-800 font-bold">Adoption</p>
              <button
                className="
									cursor-pointer
									rounded
        ...
        <div>
          <div className="border-b py-4 border-gray-200">
            <div
              ...
              className="flex justify-between items-center cursor-pointer"
            >
              <p className="text-base leading-4 text-gray-800 font-bold">Contact us</p>
              <button
                className="
									cursor-pointer
									rounded
  ...
  <a href="mailto:siddnoor15@gmail.com" className="text-blue-500 underline"> Siddiqua Noorien</a>.
